...
adapterFiles = ['adapters/pubmatic.js', 'adapters/appnexus.js', 'adapters/bRealTime.js', 'adapters/districtM.js', 'adapters/openx.js', 'adapters/rubicon.js', 'adapters/indexExchange.js', 'adapters/yieldbot.js', 'adapters/adForm.js']
